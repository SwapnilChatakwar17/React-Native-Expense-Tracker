...
const Home = ({ setloadAgain, setModal, loadAgain }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={{ fontSize: 25 }}>Expense Tracker</Text>
      ...
      <TouchableOpacity onPress={() => setModal(true)}>
        ...
        >
          <Text style={{ color: "#fff", fontSize: 15 }}>Add Expense</Text>
        </View>
      </TouchableOpacity>
      <View
        style={{ backgroundColor: "#eee", height: 3, marginVertical: 10 }}
      />
      <Text style={{ textAlign: "center", fontSize: 20, fontWeight: "bold" }}>History</Text>
      <View
        style={{ backgroundColor: "#eee", height: 3, marginVertical: 10 }}
      />
      <SwipeListView
